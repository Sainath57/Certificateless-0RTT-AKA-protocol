			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="CloudUserPK.jsp">Cloud User PK </a></li>
				...
				<form action="Down" method="post">
					<table width="100%" style="text-align: center;">
						<thead>
							...
							<tr>
								<td style="text-align: center;color: white;"><input type="text" name="fid" <%-- value="<%=fid%>"  --%> /></td>
								<td style="text-align: center;color: white;"><input type="text" name="key1" style="width: 150px;"/></td>
								<td style="text-align: center;color: white;"><input type="submit" value="Download" class="actions" /></td>
							</tr>
					</table>
				</form>
			</div>
